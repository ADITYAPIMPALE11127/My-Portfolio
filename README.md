...
6. To save the form data refer [Jamie Wilson](https://github.com/jamiewilson/form-to-google-sheets) to know more about how to use google sheets to save data from the web page forms. He has given a clear information to do so.
